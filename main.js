...
// Límite de espera para redes lentas o servidores de texturas que no responden.
...
if (!renderer) {
  console.error('No se pudo crear un contexto WebGL. Activa la aceleración gráfica del navegador.');
}
